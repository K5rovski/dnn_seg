...
np.random.seed(None)
quick_str='aenbase_'+''.join(map(chr,np.random.randint(97,97+26,(5,))) )
...
db_folder='D:/NEURON_FIBER_DATA/lmdb_base_2k_45w_autoenc_normal_mask_6milset_20pics'

save_base=True
image_width,image_height=45,45
big_image_size=2048
lookup_path = r'D:\data_projects\neuron_fibers_data\TCINT_neigh15_circ10\\' #"D:/code_projects/Neuron_fibers_workspace/neuron_fiber_images/all_test_big_spread_interim/"
...
train_mask_dir=r"D:\data_projects\neuron_fibers_data\images\patch_mask_TCINeigh_trainImgs\\"
